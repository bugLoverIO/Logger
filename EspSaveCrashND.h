...
#define SAVE_CRASH_STACK_START      0x06  // 4 bytes
#define SAVE_CRASH_STACK_END        0x0A  // 4 bytes
#define SAVE_CRASH_STACK_TRACE      0x0E  // variable
...
class EspSaveCrash
{
  public:
    ...
    void setDateOffset(uint32_t timeOffset);
